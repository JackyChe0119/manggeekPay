...
#define SafeReleaseView(obj) if(obj){if(obj.superview) {[obj removeFromSuperview];} obj=nil;}
...
#define SafeReleaseView(obj) if(obj){if(obj.superview) {[obj removeFromSuperview];} [obj release]; obj=nil;}
